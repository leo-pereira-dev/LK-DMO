...
/* ============================================================ */
/* Function: FUN_0162eb70 */
/* Entry: 0162eb70 */
/* Signature: undefined FUN_0162eb70() */
/* ============================================================ */


/* WARNING: Function: __security_check_cookie replaced with injection: security_check_cookie */

undefined4 FUN_0162eb70(undefined4 *param_1,int *param_2,uint *param_3)
    ...
    *param_3 = *param_3 + 4;
    ...
    if (local_3c != 0) {
      do {
        ...
        if (uVar5 < 4) goto LAB_0162edc8;
        if ((uint)(local_34[1] - iVar1) <= uVar6) goto LAB_0162edeb;
        ...
        uVar6 = *param_3 + 4;
        *param_3 = uVar6;
        _Size = (local_34[1] - *local_34) - uVar6;
        local_2c = local_18;
        if (_Size != 0) {
          if ((uint)(local_34[1] - *local_34) <= uVar6) goto LAB_0162edeb;
          if ((undefined1 *)(uVar6 + *local_34) == (undefined1 *)0x0) {
            ...
            *piVar7 = 0x16;
            ...
            local_24[0] = *(undefined1 *)(uVar6 + *local_34);
          }
          *param_3 = *param_3 + 1;
          uVar6 = *param_3;
        }
        ...
        if (3 < uVar5) {
          if ((uint)(iVar1 - iVar2) <= uVar6) goto LAB_0162edeb;
        ...
        if ((*(char *)(*(int *)(puVar9 + 1) + 0xd) != '\0') ||
          ...
          local_40 = 0;
          puVar10[4] = local_2c;
          *(undefined1 *)(puVar10 + 6) = local_24[0];
          puVar10[5] = &DAT_01a1a650;
          puVar10[7] = uVar11;
          *puVar10 = uVar3;
          puVar10[1] = uVar3;
          puVar10[2] = uVar3;
