...
/* ============================================================ */
/* Function: FUN_011c8b10 */
/* Entry: 011c8b10 */
/* Signature: undefined FUN_011c8b10() */
/* ============================================================ */


void __thiscall FUN_011c8b10(int *param_1,int param_2)

{
  ...
  if ((param_1[2] != 0) && (*(char *)(param_1[2] + 0x1c) != '\0')) {
    ...
    if (((param_1[3] != 0) && (iVar4 = *(int *)(param_1[3] + 0x1c), iVar4 != 0)) &&
       (iVar4 = __RTDynamicCast(*(undefined4 *)(iVar4 + 0x34),0,&DAT_01bc4a94,&DAT_01bc617c,0),
       iVar4 != 0)) {
    ...
    FUN_011c91c0((int)&uStack_4 + 3);
    cVar5 = *(char *)(param_2 + 0xc) + -1;
    if (*(char *)(param_2 + 0x18) == '\0') {
      cVar5 = *(char *)(param_2 + 0xc);
    }
    uStack_4 = (int *)CONCAT13(cVar5,(undefined3)uStack_4);
    FUN_011c9340((int)&uStack_4 + 3);
  }
  return;
}
