...
/* ============================================================ */
/* Function: FUN_011c9100 */
/* Entry: 011c9100 */
/* Signature: undefined FUN_011c9100() */
/* ============================================================ */


void __fastcall FUN_011c9100(int param_1)

{
  ...
  if (((*(int *)(param_1 + 0x14) == 0) ||
     ...
     (*(char *)(iVar1 + 0x88) == '\0')) {
    if (DAT_01bfb32c == (int *)0x0) goto LAB_011c9185;
...
LAB_011c9185:
  if ((*(int *)(param_1 + 0x1c) != 0) &&
     (iVar1 = *(int *)(*(int *)(param_1 + 0x1c) + 0x24), iVar1 != 0)) {
