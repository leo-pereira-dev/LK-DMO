...
/* ============================================================ */
/* Function: FUN_011f9d20 */
/* Entry: 011f9d20 */
/* Signature: undefined FUN_011f9d20() */
/* ============================================================ */


void __fastcall FUN_011f9d20(int param_1)
  ...
  *(undefined2 *)(param_1 + 0x74) = 0x101;
  if (cVar2 == '\0') {
    ...
    if (piVar6 == (int *)0x0) {
      ...
      FUN_01245550();
      piVar6[0x1d] = (int)&DAT_01ae489c;
      piVar6[0x1e] = 0;
      piVar6[0x1d] = (int)&DAT_01ae484c;
      local_8._0_1_ = 2;
      *piVar6 = (int)&DAT_01ae4998;
      piVar6[0x1d] = (int)&DAT_01ae49dc;
      piVar8 = piVar6 + 0x1f;
      *piVar8 = 0;
      piVar6[0x20] = 0;
      local_1c = piVar8;
    ...
    *(int **)(param_1 + 0xb0) = piVar6;
    ...
    if (piVar6 == (int *)0x0) {
      ...
      piVar6[0x1e] = 0;
      piVar6[0x1d] = (int)&DAT_01ae484c;
      *piVar6 = (int)&DAT_01ae4948;
      piVar6[0x1d] = (int)&DAT_01ae498c;
      piVar6[0x1f] = 0;
    }
    local_8 = 0xffffffff;
    *(int **)(param_1 + 0xb4) = piVar6;
    ...
    if (piVar6 == (int *)0x0) {
      ...
      local_8._0_1_ = 8;
      piVar1 = piVar6 + 0x1f;
      *piVar6 = (int)&DAT_01ae48f8;
      piVar6[0x1d] = (int)&DAT_01ae493c;
      *piVar1 = 0;
      piVar6[0x20] = 0;
      local_14 = piVar1;
      pvVar7 = operator_new(0x34);
    ...
    *(int **)(local_18 + 0xb8) = piVar6;
    ...
    if (piVar6 == (int *)0x0) {
      ...
      piVar6[0x1e] = 0;
      piVar6[0x1d] = (int)&DAT_01ae484c;
      *piVar6 = (int)&DAT_01ae48a8;
      piVar6[0x1d] = (int)&DAT_01ae48ec;
      piVar6[0x1f] = 0;
      piVar6[0x20] = 0;
      piVar6[0x21] = 0;
    }
