...
/* ============================================================ */
/* Function: FUN_012012e0 */
/* Entry: 012012e0 */
/* Signature: undefined FUN_012012e0() */
/* ============================================================ */
...
void FUN_012012e0(int param_1,int *param_2,undefined4 *param_3)
    ...
    if (local_58 != 0) {
      ...
      if (local_50 != 0) {
        ...
        *(undefined4 **)(iVar6 + 0x34) = puVar5;
        FUN_012029e0(1,local_54,FUN_01201c60,0);
        iVar11 = local_58;
      ...
      if (iVar6 != 0) {
        ...
        *local_48 = &DAT_01ae4a84;
        local_48[1] = *local_4c;
        if (*(undefined4 **)(iVar6 + 0x34) != (undefined4 *)0x0) {
          (**(code **)**(undefined4 **)(iVar6 + 0x34))(1);
        }
        *(undefined4 **)(iVar6 + 0x34) = local_48;
        FUN_012029e0(0,local_54,&LAB_01201d00,0);
        *(undefined1 *)(iVar6 + 0x78) = 0;
      ...
      if (iVar6 != 0) {
        FUN_01240640(0,0,DAT_01bee88c,DAT_01bee890,200,200,
                     s_DigiCombine_DigiCombine_Gacha_Bg_01ae1d48,0,0x14,uVar10,200,200,1,5);
        *(undefined4 *)(iVar6 + 100) = 0x3d4ccccd;
        *(undefined4 *)(iVar6 + 0x68) = 0x3d4ccccd;
      ...
      if (iVar6 == 0) {
        ...
        *(undefined4 **)(iVar6 + 0x34) = local_48;
        FUN_012029e0(0,local_54,FUN_01201e20,0);
        *(undefined1 *)(iVar6 + 0x78) = 0;
