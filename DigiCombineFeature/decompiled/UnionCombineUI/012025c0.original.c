...
/* ============================================================ */
/* Function: FUN_012025c0 */
/* Entry: 012025c0 */
/* Signature: undefined FUN_012025c0() */
/* ============================================================ */


void __thiscall FUN_012025c0(int *param_1,int param_2)

{
  ...
  if (((param_1[3] != 0) && (iVar5 = *(int *)(param_1[3] + 0x1c), iVar5 != 0)) &&
     (iVar5 = __RTDynamicCast(*(undefined4 *)(iVar5 + 0x34),0,&DAT_01bc4a94,&DAT_01bc65d0,0),
     iVar5 != 0)) {
