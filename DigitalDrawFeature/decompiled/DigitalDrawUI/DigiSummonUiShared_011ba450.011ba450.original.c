...
/* ============================================================ */
/* Function: FUN_011ba450 */
/* Entry: 011ba450 */
/* Signature: undefined FUN_011ba450() */
/* ============================================================ */


void __thiscall FUN_011ba450(int *param_1,int param_2)

{
  ...
  if ((param_1[6] != 0) && (*(char *)(param_1[6] + 0x1c) != '\0')) {
    ...
    if ((int *)param_1[2] != (int *)0x0) {
      ...
      if (*(int *)(param_1[2] + 0x24) != 0) {
        *(undefined1 *)(*(int *)(param_1[2] + 0x24) + 0x88) = 0;
      }
      iVar4 = param_1[2];
    ...
    if ((int *)param_1[3] != (int *)0x0) {
      ...
      if (*(int *)(param_1[3] + 0x24) != 0) {
        *(undefined1 *)(*(int *)(param_1[3] + 0x24) + 0x88) = 0;
      }
    }
    ...
    FUN_011bab00((int)&uStack_4 + 3);
    cVar5 = *(char *)(param_2 + 0xc) + -1;
    if (*(char *)(param_2 + 0x18) == '\0') {
      cVar5 = *(char *)(param_2 + 0xc);
    }
    uStack_4 = (int *)CONCAT13(cVar5,(undefined3)uStack_4);
    FUN_011bac80((int)&uStack_4 + 3);
  }
  return;
}
