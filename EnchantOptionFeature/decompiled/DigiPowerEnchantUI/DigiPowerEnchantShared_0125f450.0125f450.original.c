...
/* ============================================================ */
/* Function: FUN_0125f450 */
/* Entry: 0125f450 */
/* Signature: undefined FUN_0125f450() */
/* ============================================================ */


/* WARNING: Function: __security_check_cookie replaced with injection: security_check_cookie */

void __fastcall FUN_0125f450(int param_1)

{
  ...
  *(int *)(param_1 + 0xb8) = iVar2;
  if (iVar2 != 0) {
    FUN_0122b6f0(*(undefined4 *)(param_1 + 0x40),0x55,0x68,0x2a,0x2a,0,uVar6);
    *(undefined1 *)(*(int *)(param_1 + 0xb8) + 0x8c) = 0;
    FUN_012611d0(8,param_1,&LAB_012610a0,0);
    ...
    if (local_28 != (undefined4 *)0x0) {
      ...
      iVar7 = *(int *)(iVar2 + 0xfd);
      if (((iVar7 == 0) && (*(short *)(iVar2 + 0x101) == 0)) ||
         (*(int *)(iVar2 + 0x150) == 0x7fffffff)) {
        iVar7 = 0;
      }
      *(bool *)(param_1 + 200) = iVar7 != 0;
      piVar3 = (int *)FUN_01231410(10,iVar7,1,0x20,0x20,DAT_01bee88c,DAT_01bee890);
      *(int **)(param_1 + 0xc4) = piVar3;
      if (piVar3 != (int *)0x0) {
        (**(code **)(*piVar3 + 0x54))(1);
      }
