...
/* ============================================================ */
/* Function: FUN_011a5270 */
/* Entry: 011a5270 */
/* Signature: undefined FUN_011a5270() */
/* ============================================================ */


/* WARNING: Function: __security_check_cookie replaced with injection: security_check_cookie */

undefined1 __thiscall FUN_011a5270(int param_1,int param_2,undefined4 *param_3,undefined4 *param_4)

{
  ...
  if (cVar2 != '\0') {
    ...
    *(int *)(param_1 + 0x8c) = iVar4;
    if (iVar4 != 0) {
      FUN_011a8c90(1,param_1,&LAB_011a70f0,0);
      iVar4 = *(int *)(param_1 + 0x78);
      local_51 = 0xd;
      FUN_00f489b0(local_64,&local_51);
      if (((local_5c[0xd] == '\0') && ((byte)local_5c[0x10] < 0xe)) &&
    ...
    *(int *)(param_1 + 0x90) = iVar4;
    if (iVar4 != 0) {
      ...
      uVar11 = 0;
      uVar12 = 0;
      FUN_00f19cc0(s_EXTRA_INVEN_Evolution_BTN_ALLGET_01ae0f98,0x20);
      ...
      FUN_011a8c90(1,param_1,FUN_011a7250,0);
      local_8 = 0xffffffff;
      local_24 = 0;
      FUN_00f1a330();
    }
