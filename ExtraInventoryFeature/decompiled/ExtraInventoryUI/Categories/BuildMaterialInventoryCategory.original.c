...
/* ============================================================ */
/* Function: FUN_011ab290 */
/* Entry: 011ab290 */
/* Signature: undefined FUN_011ab290() */
/* ============================================================ */


/* WARNING: Function: __security_check_cookie replaced with injection: security_check_cookie */

undefined1 __thiscall FUN_011ab290(int param_1,int param_2,undefined4 *param_3,undefined4 *param_4)

{
  ...
  if (cVar2 != '\0') {
    ...
    *(int *)(param_1 + 0x88) = iVar4;
    if (iVar4 != 0) {
      FUN_011ac640(1,param_1,&LAB_011abe90,0);
      iVar4 = *(int *)(param_1 + 0x78);
      local_51 = 0xf;
      FUN_00f489b0(local_64,&local_51);
      if (((local_5c[0xd] == '\0') && ((byte)local_5c[0x10] < 0x10)) &&
    ...
    *(int *)(param_1 + 0x8c) = iVar4;
    if (iVar4 != 0) {
      ...
      uVar11 = 0;
      uVar12 = 0;
      FUN_00f19cc0(s_EXTRA_INVEN_MATERIAL_BTN_ALLGET_01ae1354,0x1f);
      ...
      FUN_011ac640(1,param_1,&LAB_011abec0,0);
      local_8 = 0xffffffff;
      local_24 = 0;
      FUN_00f1a330();
    }
