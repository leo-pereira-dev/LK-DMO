...
/* ============================================================ */
/* Function: FUN_011a3020 */
/* Entry: 011a3020 */
/* Signature: undefined FUN_011a3020() */
/* ============================================================ */


void __fastcall FUN_011a3020(int param_1)
  ...
  *(int *)(param_1 + 0x7c) = iVar2;
  if (iVar2 != 0) {
    ...
    *(undefined1 *)(iVar2 + 0xa9) = 0;
    ...
    FUN_011a40f0(7,pvVar1,FUN_011a33f0,0);
    FUN_011a40f0(6,pvVar1,&LAB_011a35d0,0);
