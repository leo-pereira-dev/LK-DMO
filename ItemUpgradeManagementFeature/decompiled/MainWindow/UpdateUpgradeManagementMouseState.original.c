...
/* ============================================================ */
/* Function: FUN_01279340 */
/* Entry: 01279340 */
/* Signature: undefined FUN_01279340() */
/* ============================================================ */


/* WARNING: Function: __security_check_cookie replaced with injection: security_check_cookie */

int __fastcall FUN_01279340(int param_1)

{
  ...
  if ((*(int **)(param_1 + 0xb0) != (int *)0x0) &&
     (iVar3 = (**(code **)(**(int **)(param_1 + 0xb0) + 0x44))(), iVar3 == 4)) {
    return iVar2;
  }
  if (*(char *)(param_1 + 0xbc) == '\0') {
    if ((*(int **)(param_1 + 0xb4) != (int *)0x0) &&
       (iVar3 = (**(code **)(**(int **)(param_1 + 0xb4) + 0x34))(), iVar3 != 0)) {
      return iVar2;
    }
    if ((*(int **)(param_1 + 0xac) != (int *)0x0) &&
       (iVar3 = (**(code **)(**(int **)(param_1 + 0xac) + 0x44))(), iVar3 == 4)) {
      return iVar2;
    }
    iStack_2c = *(int *)(param_1 + 0x34);
    iStack_30 = *(int *)(param_1 + 0x30);
    iStack_28 = iStack_30 + 0x2ee;
