...
/* ============================================================ */
/* Function: FUN_0126b830 */
/* Entry: 0126b830 */
/* Signature: undefined FUN_0126b830() */
/* ============================================================ */


void __fastcall FUN_0126b830(int param_1)

{
  ...
  *(int **)(param_1 + 0x120) = piVar4;
  if (piVar4 != (int *)0x0) {
    ...
    *(undefined4 *)(*(int *)(param_1 + 0x120) + 0xd4) = 0x3c23d70a;
    ...
    (**(code **)(*piVar4 + 0x48))();
    FUN_01242bf0();
    (**(code **)(**(int **)(param_1 + 0x120) + 0x1c))(1);
    FUN_0126c890(1,param_1,FUN_0126c670,0);
    FUN_012472c0(*(undefined4 *)(param_1 + 0x120));
    FUN_012695b0(1,*(undefined4 *)(param_1 + 0x120));
  }
  pvVar3 = (void *)FUN_016830c0(0x1ac,uVar2);
  local_8 = 1;
  if (pvVar3 == (void *)0x0) {
  ...
  *(int **)(param_1 + 0x124) = piVar4;
  if (piVar4 != (int *)0x0) {
    ...
    *(undefined2 *)puVar5 = 0;
    FUN_012427e0(s_Item_Make_Make_ani_gauge_pixel_t_01ae8aac);
    FUN_01242970(s_EquipSystem_Upgrade_Empty_Line_t_01ae8b88);
    *(undefined4 *)(*(int *)(param_1 + 0x124) + 0xd4) = 0x3c23d70a;
    ...
    (**(code **)(*piVar4 + 0x48))();
    FUN_01242bf0();
    (**(code **)(**(int **)(param_1 + 0x124) + 0x1c))(1);
    FUN_0126c890(1,param_1,FUN_0126c670,0);
    FUN_012472c0(*(undefined4 *)(param_1 + 0x124));
    FUN_012695b0(2,*(undefined4 *)(param_1 + 0x124));
  }
