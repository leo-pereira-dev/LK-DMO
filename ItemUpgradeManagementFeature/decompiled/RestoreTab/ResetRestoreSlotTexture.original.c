...
/* ============================================================ */
/* Function: FUN_0126bd30 */
/* Entry: 0126bd30 */
/* Signature: undefined FUN_0126bd30() */
/* ============================================================ */


/* WARNING: Function: __security_check_cookie replaced with injection: security_check_cookie */

void __fastcall FUN_0126bd30(int param_1)

{
  ...
  if (*(int *)(param_1 + 0xc0) != 0) {
    (**(code **)(*(int *)(*(int *)(param_1 + 0xc0) + 0x14) + 0x10))(&DAT_01ac5dd8,local_14);
  }
