...
/* ============================================================ */
/* Function: FUN_012703e0 */
/* Entry: 012703e0 */
/* Signature: undefined FUN_012703e0() */
/* ============================================================ */


void __fastcall FUN_012703e0(int param_1)

{
  ...
  *(int *)(param_1 + 0x134) = iVar3;
  if (iVar3 != 0) {
    ...
    *(undefined1 *)(*(int *)(param_1 + 0x134) + 0x78) = 0;
    (**(code **)(**(int **)(param_1 + 0x134) + 0x1c))(0);
    FUN_01271c10(0,param_1,FUN_01270970,0);
  }
  pvVar2 = (void *)FUN_016830c0(0x8c,uVar1);
  local_8 = 1;
  if (pvVar2 == (void *)0x0) {
  ...
  *(int *)(param_1 + 0x138) = iVar3;
  if (iVar3 != 0) {
    ...
    *(undefined4 *)(iVar3 + 100) = 0x3d23d70a;
    *(undefined4 *)(iVar3 + 0x68) = 0x3d23d70a;
    *(undefined1 *)(*(int *)(param_1 + 0x138) + 0x78) = 0;
    (**(code **)(**(int **)(param_1 + 0x138) + 0x1c))(0);
    FUN_01271c10(0,param_1,FUN_01270db0,0);
  }
  ...
  *(int *)(param_1 + 0x13c) = iVar3;
  if (iVar3 != 0) {
    ...
    *(undefined4 *)(iVar3 + 100) = 0x3d23d70a;
    *(undefined4 *)(iVar3 + 0x68) = 0x3d23d70a;
    *(undefined1 *)(*(int *)(param_1 + 0x13c) + 0x78) = 0;
    (**(code **)(**(int **)(param_1 + 0x13c) + 0x1c))(0);
    FUN_01271c10(0,param_1,FUN_01270db0,0);
  }
  ExceptionList = local_10;
  return;
