...
/* ============================================================ */
/* Function: FUN_0164d340 */
/* Entry: 0164d340 */
/* Signature: undefined FUN_0164d340() */
/* ============================================================ */


/* WARNING: Function: __security_check_cookie replaced with injection: security_check_cookie */

undefined4 FUN_0164d340(int *param_1,int *param_2,uint *param_3)
    ...
    *param_3 = *param_3 + 4;
    ...
    if (uVar8 != 0) {
      do {
        ...
        local_28 = 0;
        local_18 = 0;
        local_20 = &DAT_01a1b558;
        uVar11 = param_2[1] - *param_2;
        _Size = uVar11 - uVar7;
        if (_Size < 4) goto LAB_0164d557;
        if (uVar11 <= uVar7) goto LAB_0164d575;
