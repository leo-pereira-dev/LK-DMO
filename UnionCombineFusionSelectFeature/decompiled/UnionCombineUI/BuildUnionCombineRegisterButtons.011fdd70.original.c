...
/* ============================================================ */
/* Function: FUN_011fdd70 */
/* Entry: 011fdd70 */
/* Signature: undefined FUN_011fdd70() */
/* ============================================================ */


/* WARNING: Function: __security_check_cookie replaced with injection: security_check_cookie */

void __fastcall FUN_011fdd70(int param_1)

{
  ...
  *(int *)(param_1 + 0xa8) = iVar3;
  ...
  if (iVar3 != 0) {
    ...
    FUN_01200260(1,param_1,FUN_011fcc60,0);
    local_14 = 0xffffffff;
    local_34 = 0;
    FUN_00f1a330();
  }
  iVar3 = FUN_012462c0(s_Unionmon_Ev_UI_Ev_Btn_tga_01ae4a3c,4,1,0x366,0x247,0x55,0x1e,0,0x36);
  *(int *)(param_1 + 0xb4) = iVar3;
  if (iVar3 != 0) {
    ...
    FUN_00f1a330();
    FUN_01224f40(&local_60);
    FUN_01200260(1,param_1,FUN_011fc7f0,0);
  ...
  *(int *)(param_1 + 0xac) = iVar3;
  if (iVar3 != 0) {
    ...
    FUN_00f1a330();
    FUN_01224f40(&local_60);
    FUN_01200260(1,param_1,&LAB_011fc080,0);
    local_14 = 0xffffffff;
    local_34 = 0;
    FUN_00f1a330();
  }
  ...
  *(int *)(param_1 + 0xa4) = iVar3;
  if (iVar3 != 0) {
    ...
    FUN_00f1a330();
    FUN_01224f40(&local_60);
    FUN_01200260(1,param_1,FUN_011fc890,0);
    local_14 = 0xffffffff;
    local_34 = 0;
    FUN_00f1a330();
  }
  ...
  *(int *)(param_1 + 0xb0) = iVar3;
  if (iVar3 != 0) {
    ...
    FUN_00f1a330();
    FUN_01224f40(&local_60);
    FUN_01200260(1,param_1,FUN_011fc0a0,0);
    local_14 = 0xffffffff;
    local_34 = 0;
    FUN_00f1a330();
  }
