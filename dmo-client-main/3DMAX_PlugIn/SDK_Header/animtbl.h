...
#define A_RESERVED_B02	 		(1<<2) // reserved for future internal use
#define A_RESERVED_B03			(1<<3) // reserved for future internal use
...
#ifdef _OSNAP
#define A_OBJ_LONG_CREATE		(1<<6)		// Persists throughout the whole creation process as 
...
#define A_ORT_DISABLED			(1<<19)	// indicates that the ORT is disabled
...
#endif
#define A_INODE_IN_UPDATE		(1<<9) // Used internally only
#define A_INODE_IN_UPDATE_TM	(1<<10) // Flag is set if it's updating it's TM. Don't Call GetNodeTM if it is.

// CompositeBase Flags
#define A_COMPONENT_LOCKED		(1<<19)	// needed for CompositeBase and its children (NOTE: CompositeBase derives from ShapeObject)
...
#define A_RESERVED_B16	 				(1<<16) // reserved for future internal use

// Flag used internally by FileLink for replacing Acad controllers, and is used on controllers. Nothing else should use it.
#define A_CHANGE_PARENTS_DONE			(1<<17)

// Flag used internally to flag that at least one reference has been set on a refmaker, and that
// the refmaker's references were checked at that time to make sure they were all NULL.
#define A_REFMAKER_REFS_CHECKED			(1<<18) //!< An refmaker's initial references have been checked

// Reserved for superclass use
#define A_SUPERCLASS1		(1<<20)
#define A_SUPERCLASS2		(1<<21)

// These are reserved for use by the plug-in. Nothing will set these flags except the plug-in class itself.
...
// General work flags. These can be used by both core and plugins. 
#define A_WORK1				(1<<28)
#define A_WORK2				(1<<29)
#define A_WORK3				(1<<30)
#define A_WORK4				(1<<31)
...
//! \brief Values for Animatable extended flags
/*! 
...
#define A_EX_RESERVED_B00	 		(1<<0) //!< reserved for future internal use
#define A_EX_RESERVED_B01	 		(1<<1) //!< reserved for future internal use
#define A_EX_RESERVED_B02	 		(1<<2) //!< reserved for future internal use
#define A_EX_RESERVED_B03	 		(1<<3) //!< reserved for future internal use
#define A_EX_RESERVED_B04	 		(1<<4) //!< reserved for future internal use
#define A_EX_RESERVED_B05	 		(1<<5) //!< reserved for future internal use
#define A_EX_RESERVED_B06	 		(1<<6) //!< reserved for future internal use
#define A_EX_RESERVED_B07	 		(1<<7) //!< reserved for future internal use
#define A_EX_RESERVED_B08	 		(1<<8) //!< reserved for future internal use
#define A_EX_RESERVED_B09	 		(1<<9) //!< reserved for future internal use
#define A_EX_RESERVED_B10	 		(1<<10) //!< reserved for future internal use
#define A_EX_RESERVED_B11	 		(1<<11) //!< reserved for future internal use
#define A_EX_RESERVED_B12	 		(1<<12) //!< reserved for future internal use
#define A_EX_RESERVED_B13	 		(1<<13) //!< reserved for future internal use
#define A_EX_RESERVED_B14	 		(1<<14) //!< reserved for future internal use
#define A_EX_RESERVED_B15	 		(1<<15) //!< reserved for future internal use
#define A_EX_RESERVED_B16	 		(1<<16) //!< reserved for future internal use
#define A_EX_RESERVED_B17	 		(1<<17) //!< reserved for future internal use
#define A_EX_RESERVED_B18	 		(1<<18) //!< reserved for future internal use
#define A_EX_RESERVED_B19	 		(1<<19) //!< reserved for future internal use
#define A_EX_RESERVED_B20	 		(1<<20) //!< reserved for future internal use
#define A_EX_RESERVED_B21	 		(1<<21) //!< reserved for future internal use
#define A_EX_RESERVED_B22	 		(1<<22) //!< reserved for future internal use
#define A_EX_RESERVED_B23	 		(1<<23) //!< reserved for future internal use
#define A_EX_RESERVED_B24	 		(1<<24) //!< reserved for future internal use
#define A_EX_RESERVED_B25	 		(1<<25) //!< reserved for future internal use
#define A_EX_RESERVED_B26	 		(1<<26) //!< reserved for future internal use
#define A_EX_RESERVED_B27	 		(1<<27) //!< reserved for future internal use
#define A_EX_RESERVED_B28	 		(1<<28) //!< reserved for future internal use
#define A_EX_RESERVED_B29	 		(1<<29) //!< reserved for future internal use
#define A_EX_RESERVED_B30	 		(1<<30) //!< reserved for future internal use
#define A_EX_RESERVED_B31	 		(1<<31) //!< reserved for future internal use
...
#define I_IKCONTROL			0x00001002 //!< An Animatable supporting this interface is a IIKControl
#define I_IKCHAINCONTROL	0x00001003 //!< An Animatable supporting this interface is a IIKChainControl
#define I_WIRECONTROL		0x00001004 //!< An Animatable supporting this interface is a IBaseWireControl
#define I_SCRIPTCONTROL		0x00001005 //!< An Animatable supporting this interface is a IBaseScriptControl
#define I_MASTER			0x00001010 //!< An Animatable supporting this interface is a ReferenceTarget
#define I_EASELIST			0x00001020 //!< An Animatable supporting this interface is a EaseCurveList
...
#define I_DERIVEDOBJECT		0x00001042 //!< An Animatable supporting this interface is a IDerivedObject
#define I_OBJECT			0x00001043 //!< An Animatable supporting this interface is a Object 
...
#define I_KEYCONTROL		0x00001060 //!< An Animatable supporting this interface is a IKeyControl
#define I_KEYCONTROL2		0x00001061 //!< An Animatable supporting this interface is a IKeyControl2
#define I_SETKEYCONTROL		0x00001065 //!< An Animatable supporting this interface is a ISetKey
#define I_SYSTEM_XREF		0x00001066 //!< An Animatable supporting this interface is a ISystemXRef

#define I_TEXTOBJECT		0x00001070 //!< An Animatable supporting this interface is a ITextObject
#define I_WAVESOUND			0x00001080 //!< An Animatable supporting this interface is a IWaveSound
#ifdef _SUBMTLASSIGNMENT
#define I_SUBMTLAPI			0x00001090 //!< An Animatable supporting this interface is a ISubMtlAPI
#endif
...
#define	I_NEWPARTOPERATOR	0x00002032 //!< An Animatable supporting this interface is a IOperatorInterface
#define	I_NEWPARTTEST		0x00002033 //!< An Animatable supporting this interface is a ITestInterface. This is an obsolete interface.

#define I_MESHSELECT		0x000010A0 //!< An Animatable supporting this interface is a IMeshSelect
#define I_MESHSELECTDATA	0x000010B0 //!< An Animatable supporting this interface is a IMeshSelectData
...
#define I_SPLINESELECT		0x000010F0 //!< An Animatable supporting this interface is a ISplineSelect
#define I_SPLINESELECTDATA	0x00001100 //!< An Animatable supporting this interface is a ISplineSelectData
#define I_SPLINEOPS			0x00001110 //!< An Animatable supporting this interface is a ISplineOps
#define I_PATCHSELECT		0x00001120 //!< An Animatable supporting this interface is a IPatchSelect
#define I_PATCHSELECTDATA	0x00001130 //!< An Animatable supporting this interface is a IPatchSelectData
#define I_PATCHOPS			0x00001140 //!< An Animatable supporting this interface is a IPatchOps
#define I_SUBMAP			0x00001150 //!< An Animatable supporting this interface is a ISubMap
...
#define	I_NEWMTLINTERFACE	0x00002010 //!< An Animatable supporting this interface is a IChkMtlAPI

#define I_COMPONENT			0x0000F010 //!< An Animatable supporting this interface is a IComponent
#define I_REFARRAY			0x0000F030 //!< An Animatable supporting this interface is a IRefArray
// REQUIRES RELEASE (?)
#define I_REAGENT			0x0000F060 //!< An Animatable supporting this interface is a IReagent 
#define I_GEOMIMP			0x0000F070 //!< An Animatable supporting this interface is a IGeomImp - implementaion neutral interface to geometry caches - REQUIRES RELEASE
#define I_AGGREGATION		0x0000F080 //!< An Animatable supporting this interface is a IAggregation
#define I_VALENCE			0x0000F090 //!< An Animatable supporting this interface is a IValence
#define I_GUEST				0x0000F100 //!< An Animatable supporting this interface is a IGuest
#define I_HOST				0x0000F110 //!< An Animatable supporting this interface is a IHost
#define I_SCENEOBJECT		0x0000F120 //!< An Animatable supporting this interface is a Object
#define I_MULTITANGENT		0x0000F130 //!< An Animatable supporting this interface is a IAdjustMultipleTangents
#define I_SOFTSELECT		0x0000F140 //!< An Animatable supporting this interface is a ISoftSelect
#define I_UNREPLACEABLECTL	0x0000F150 //!< An Animatable supporting this interface is a IUnReplaceableControl - used for the exposetransform controllers
#define I_EULERCTRL			0x0000F160 //!< An Animatable supporting this interface is a IEulerControl - used for euler controllers in order to get/set the xyz ordering..
...
#define FILE_ENUM_ACCESSOR_INTERFACE (1<<14)	// The callback object passed through is a 
												// IEnumAuxAssetsCallback derived object
...
class Animatable : public InterfaceServer {
	...
	public:	
		...
		public:
			...
			/*! \param[in] theAnim - A pointer to the Animatable
...
//@{
		...
		/*! \param[in, out] s Reference to a string filled in with the name of the plugin class
		*/
		...
		plugins. Note that several plugin classes can be of the same type, thus return
...
//@}
		...
		/*! \param[in] mask The bits to turn on in the Animatable flags*/
		...
		/*! \param[in] mask The bits to test in the Animatable flags
		\return TRUE if one or more bit specified in the mask are also set in the Animatable flags*/
		BOOL TestAFlag(DWORD mask) { 
			return (aflag & mask ? TRUE : FALSE); 
		}

		//! Sets one or more bits in the Animatable extended flags
		/*! \param[in] mask The bits to turn on in the Animatable extended flags*/
		void SetAFlagEx(DWORD mask) { 
			aflag_ex |= mask; 
		}

		//! Clears one or more bits in the Animatable extended flags
		/*! \param[in] mask The bits to turn off in the Animatable extended flags*/
		void ClearAFlagEx(DWORD mask) { 
			aflag_ex &= ~mask; 
		}

		//! Tests one or more bits in the Animatable extended flags
		/*! \param[in] mask The bits to test in the Animatable extended flags
		\return TRUE if one or more bit specified in the mask are also set in the Animatable extended flags*/
		...
		//
		//=============================================================================
		DWORD GetAFlag() { return aflag; }
		AnimPropertyList* GetAProps() { return &aprops; }
		//=============================================================================
		//
		//=============================================================================

		//! \brief Requests an unique flag bit index 
		/*! The flag bit index is used with the TestFlagBit, SetFlagBit, ClearFlagBit, and 
		ClearFlagBitInAllAnimatables methods. The flag bit index must be released using the
		ReleaseFlagBit method. The intended usage of the flag bit index is in enumerations
		where you want to visit each Animatable only once, and the usage of the flag bit is 
		of a temporary, short term usage. The flag bits are not saved with the Animatable, 
		nor copied via the assign operator. The flag bits referred to for these methods are 
		not associated with the aflag or aflag_ex data members.
		\return The unique flag bit index*/
		CoreExport static int RequestFlagBit();
		
		//! Releases the flag bit index
		/*! \param[in] index The flag bit index to release*/
		CoreExport static void ReleaseFlagBit(int index);
		
		//! Tests the specified flag bit
		/*! \param[in] index The flag bit index to test
		\return TRUE if the flag bit is set*/
		CoreExport bool TestFlagBit(int index);
		
		//! Sets the specified flag bit
		/*! \param[in] index The flag bit index to set
		/*! \param[in] newValue The value to set the flag bit index to*/
		CoreExport void SetFlagBit(int index, bool newValue = true);
		
		//! Clears the specified flag bit
		/*! \param[in] index The flag bit index to clear*/
		...
		\param [in] enumProcObject - The callback object called for each animatable.*/
		...
		// If delNote is FALSE the note track will be removed from the anim but not deleted.
		...
		*/
		...
		\param [in] cid - The Class_ID of the owner of the chunk.
		\param [in] sid - The SuperClassID of the owner of the chunk.
		\param [in] sbid - An extra ID that lets the owner identify its sub-chunks.
		\param [in] dataLength - The length of the data in bytes.
		\param [in] data - Pointer to the actual data. The data should be allocated 
		...
		*/
		CoreExport void AddAppDataChunk(Class_ID cid, SClass_ID sid, DWORD sbid, DWORD dataLength, void *data);
...
class AppDataChunk: public MaxHeapOperators {
	public:
		...
		/*! \brief Constructor
		The data members are initialized to the values passed. Note that the data pointer 
		should be allocated with MAX_malloc() since it will be freed using MAX_free()
		in the destructor. MAX_malloc() and MAX_free() are memory management routines 
		implemented by the system. 
		\param [in] cid - The Class_ID of the owner of the custom data.
		\param [in] sid - The SuperClassID of the owner of the custom data.
		\param [in] sbid - An extra ID that lets the owner identify its sub-custom-data (chunks).
		*/
		CoreExport AppDataChunk(Class_ID cid, SClass_ID sid, DWORD sbid, DWORD len, void *d);
		/*! Constructor
