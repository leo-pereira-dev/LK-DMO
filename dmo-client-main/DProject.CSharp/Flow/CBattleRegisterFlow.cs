...
public sealed class CBattleRegisterFlow : CFlow
{
    public CBattleRegisterFlow(FLOW_IDS id, FlowContext context) : base(id, context)
    {
    }
    ...
    protected override void UpdateFrame()
    {
        ...
        {
            Context.FlowMgr.ChangeFlow(FLOW_IDS.FLW_BATTLE);
        }
    }
}
