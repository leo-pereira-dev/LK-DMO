...
class CServerRelocatePage;
class CFade;

//---------------------------------------------------------------------------
namespace Flow
{
	class CCharacterServerRelocateFlow : public CFlow
	{
	public:
		CCharacterServerRelocateFlow(int p_iID);
		virtual ~CCharacterServerRelocateFlow();
	...
	private:
		bool					m_bBgmPlay;
		CFade*					m_pFadeUI;
		CServerRelocatePage*		m_pServerChange;
	};
}
//---------------------------------------------------------------------------