...
char (*XRtlpNumberOf(T (&)[N] ))[N];

#define XRTL_NUMBER_OF_V2(A) (sizeof(*XRtlpNumberOf(A)))

#define XARRAYSIZE(A)    XRTL_NUMBER_OF_V2(A)

#endif

#endif

#if !defined(XARRAYSIZE)

#define XARRAYSIZE(A)    (sizeof((arr))/sizeof(*(arr)))
