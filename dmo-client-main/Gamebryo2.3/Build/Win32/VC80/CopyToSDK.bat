...
if exist ..\..\..\..\..\..\Gamebryo2.3 set SDK_INCLUDE=..\..\..\..\..\..\Gamebryo2.3\GB_Include
if exist ..\..\..\..\..\Gamebryo2.3 set SDK_INCLUDE=..\..\..\..\..\Gamebryo2.3\GB_Include
if exist ..\..\..\..\Gamebryo2.3    set SDK_INCLUDE=..\..\..\..\Gamebryo2.3\GB_Include
if exist ..\..\..\Gamebryo2.3       set SDK_INCLUDE=..\..\..\Gamebryo2.3\GB_Include
if exist ..\..\Gamebryo2.3          set SDK_INCLUDE=..\..\Gamebryo2.3\GB_Include
...
:: COPY STANDARD FILES
if exist ..\Ni*.h      xcopy /D /F /I /R /Y ..\Ni*.h      %SDK_INCLUDE%
if exist ..\Ni*.inl    xcopy /D /F /I /R /Y ..\Ni*.inl    %SDK_INCLUDE%
if exist ..\..\Ni*.h   xcopy /D /F /I /R /Y ..\..\Ni*.h   %SDK_INCLUDE%
if exist ..\..\Ni*.inl xcopy /D /F /I /R /Y ..\..\Ni*.inl %SDK_INCLUDE%
