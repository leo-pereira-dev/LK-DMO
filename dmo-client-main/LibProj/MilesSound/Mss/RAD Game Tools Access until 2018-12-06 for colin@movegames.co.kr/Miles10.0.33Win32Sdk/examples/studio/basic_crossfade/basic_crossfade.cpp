...
void main()
{
    ...
    MilesProjectLoad(Driver, "basic_crossfade.mprj", 0, 0);
    HMILESBANK Bank = MilesBankLoad(Driver, "basic_crossfade.mbnk", "basic_crossfade_stream.mstr", 0, 0);
    ...
    MilesQueueEventRun(queue, "Startmusic");
