                   ...
                   LPSTR lpszCmdLine, int nCmdShow)
{
   ...
   if (input_source == SOURCE_FILE)
      ...
      transmit_stream = XMIT_stream_open(MSS_alloc_info, MSS_free_info, 0,
                                         XMIT_stream_CB,
                                         0);
   ...
   RECV.stream = RECV.ASI_stream_open(MSS_alloc_info, MSS_free_info, 0,
                                      RECV_stream_CB,
                                      0);
