...
#define FLT_F_PARMEQ_Q       "ParmEQ Q"
#define FLT_F_PARMEQ_CENTER  "ParmEQ Center"
#define FLT_F_PARMEQ_GAIN    "ParmEQ Gain"
#define FLT_F_WET_LEVEL "Wet Level"
#define FLT_F_DRY_LEVEL "Dry Level"

#define PROVIDER_SPU_INDEX 8
...
extern "C" S32 ParmEqMain( HPROVIDER provider_handle, U32 up_down, RIB_ALLOC_PROVIDER_HANDLE_TYPE * rib_alloc, RIB_REGISTER_INTERFACE_TYPE * rib_reg, RIB_UNREGISTER_INTERFACE_TYPE * rib_unreg );
extern "C" S32 ParmEqMain( HPROVIDER provider_handle, U32 up_down, RIB_ALLOC_PROVIDER_HANDLE_TYPE * rib_alloc, RIB_REGISTER_INTERFACE_TYPE * rib_reg, RIB_UNREGISTER_INTERFACE_TYPE * rib_unreg )
{
   ...
   const RIB_INTERFACE_ENTRY FLTSMP2[] =
      ...
      REG_PR(FLT_F_PARMEQ_CENTER,             _FX_PARMEQ_CENTER  ,         RIB_FLOAT),
      };

   const RIB_INTERFACE_ENTRY FLTSMP3[] =
      {
      REG_PR(FLT_F_PARMEQ_Q,                  _FX_PARMEQ_Q,                RIB_FLOAT),
      REG_PR(FLT_F_PARMEQ_GAIN,               _FX_PARMEQ_GAIN    ,         RIB_FLOAT),
      };
