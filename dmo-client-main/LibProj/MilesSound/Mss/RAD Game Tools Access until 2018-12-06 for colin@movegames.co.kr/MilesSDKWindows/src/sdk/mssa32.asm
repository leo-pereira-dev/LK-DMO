...
; // @cdep pre $requiresifexists(mssmixerjt.inc)
include mssmixerjt.inc
...
;## 0x0008: SSE2 extensions present                                         ##
;##                                                                         ##
...
ELSE
                test    edx,04000000h   ;test SSE2 bit
                jz      __CheckSSE1     ;if clear, SSE2 not supported

                or      esi,8           ;set bit to indicate SSE2 support
...
__load_src:     mov PTR_EBX,lpLeftVal
                ...
                call vector_table[PTR_EAX * PTR_SIZE]
