...
static S32 AILCALL PROVIDER_property (HPROPERTY index, void * before_value, void const * new_value, void * after_value)
{
   switch ( index )
      ...
      case PROVIDER_NAME:
        if (before_value)
        {
          *(char **)before_value = "Dolby Surround Matrix Filter";
          return 1;
        }
        break;
...
DXDEF S32 AILEXPORT RIB_MAIN_NAME(DolbySurround)( HPROVIDER provider_handle, U32 up_down, RIB_ALLOC_PROVIDER_HANDLE_TYPE * rib_alloc, RIB_REGISTER_INTERFACE_TYPE * rib_reg, RIB_UNREGISTER_INTERFACE_TYPE * rib_unreg )
{
   ...
   const RIB_INTERFACE_ENTRY FLT4[] =
      {
      REG_PR("Driver_state_size", _FX_PROVIDER_DRIVER_STATE_SIZE, (RIB_DATA_SUBTYPE) (RIB_READONLY|RIB_DEC)),
      };
