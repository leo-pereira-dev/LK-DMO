...
static WAVE_ENTRY *WVL_search(void *wave_lib, S32 bank, S32 patch)
{
   WAVE_ENTRY *E;
   S32        i;

   E = (WAVE_ENTRY *) wave_lib;
                          ...
                          S32        data_2)
{
   ...
   switch (st)
      ...
      case EV_NOTE_ON:
         ...
         if (voice == W->n_voices)
            {
               // 4.1.2014 - always UINT cause ULONG shouldn't ever be what we want.
            t = UINT_MAX;
                                                  ...
                                                  S32        polyphony)
{
   ...
   for (i=0; i < NUM_CHANS; i++)
      ...
      W->controls.bend_range[i] = (S32) AIL_get_preference(MDI_DEFAULT_BEND_RANGE);
      }
