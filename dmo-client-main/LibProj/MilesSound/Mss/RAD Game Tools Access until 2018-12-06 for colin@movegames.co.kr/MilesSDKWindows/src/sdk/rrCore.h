...
// special align for SPU only (does nothing on non-ps3 and non-spu)
#ifdef __RADCELL__
...
// non-native Get/Put implementations go here :
  ...
  RADDEFFUNC unsigned short __loadshortbytereverse(int offset, const void *base);
  RADDEFFUNC unsigned long  __loadwordbytereverse (int offset, const void *base);

  RADDEFFUNC void           __storeshortbytereverse(unsigned short val, int offset, void *base);
  RADDEFFUNC void           __storewordbytereverse (unsigned int   val, int offset, void *base);
  ...
  #ifndef RR_GET64_LE
    #define RR_GET64_LE(ptr)        ( ((U64)RR_GET32_LE_OFFSET(ptr,4)<<32) | RR_GET32_LE(ptr) )
  #endif
  #ifndef RR_PUT64_LE
    #define RR_PUT64_LE(ptr,val)    RR_PUT32_LE(ptr, (U32) (val)), RR_PUT32_LE_OFFSET(ptr, (U32) ((val)>>32),4)
  #endif
#elif defined(__RADPS3__)
  #include <ppu_intrinsics.h>

  #define RR_GET16_LE(ptr)        __lhbrx((void *)(ptr))
  #define RR_PUT16_LE(ptr,val)    __sthbrx((void *)(ptr), (U16) (val))

  #define RR_GET16_LE_OFFSET(ptr,offset)        __lhbrx((void *)RR_U16_PTR_OFFSET(ptr, offset))
  #define RR_PUT16_LE_OFFSET(ptr,val,offset)    __sthbrx((void *)RR_U16_PTR_OFFSET(ptr, offset), (U16) (val))

  #define RR_GET32_LE(ptr)        __lwbrx((void *)(ptr))
  #define RR_PUT32_LE(ptr,val)    __stwbrx((void *)(ptr), (U32) (val))

  #define RR_GET64_LE(ptr)        __ldbrx((void *)(ptr))
  #define RR_PUT64_LE(ptr,val)    __stdbrx((void *)(ptr), (U64) (val))

  #define RR_GET32_LE_OFFSET(ptr,offset)        __lwbrx((void *)RR_U32_PTR_OFFSET(ptr, offset))
  #define RR_PUT32_LE_OFFSET(ptr,val,offset)    __stwbrx((void *)RR_U32_PTR_OFFSET(ptr, offset), (U32) (val))
