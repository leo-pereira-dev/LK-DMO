...
static char SECTION[]="Miles Midi Studio";
...
static void show_about()
{
   ...
   lstrcat(text," " MSS_COPYRIGHT "\n\n"
                "The Miles Midi Studio from the Miles Sound System."
   ...
   MessageBox(par,text,"About the Miles Midi Studio...", MB_OK);
}
...
#ifdef IS_WIN64
        SetClassLongPtr(par, GCLP_HICON, (LONG_PTR) LoadIcon(hInst,"MILESMID"));
#else
        SetClassLong(par, GCL_HICON, (U32) (UINTa) LoadIcon(hInst,"MILESMID"));
#endif
                   ...
                   LPSTR lpszCmdLine, int nCmdShow)
{
   ...
   fn.lpstrInitialDir   = dir;
   fn.nMaxFile          = 4096;
   fn.lpstrTitle        = "Miles Midi Studio";
