...
const tSigned32 PATHENGINE_INTERFACE_MINOR_VERSION = 2;
...
public:
    ...
    virtual iMesh* buildMeshByCopyingConnectedGround(const iMesh* baseMesh, const cPosition* positionBuffer, tUnsigned32 positionBufferSize, const char *const* options) = 0;
};
...
{
public:
    void put(const char*, tUnsigned32) {}
};
#endif
