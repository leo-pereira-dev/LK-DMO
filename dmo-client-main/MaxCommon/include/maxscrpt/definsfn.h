...
#define def_generic_debug_ok(fn, name)											\
	Generic fn##_gf (&_T("%"#name), &Value::fn##_vf, NULL, DEBUGGER_SAFE)
#define def_visible_generic_debug_ok(fn, name)									\
	Generic fn##_gf (_T(name), &Value::fn##_vf, NULL, DEBUGGER_SAFE)
#define def_struct_generic_debug_ok(fn, _struct, name)							\
	Generic fn##_gf (_T(name), &Value::fn##_vf, _T(#_struct), DEBUGGER_SAFE)
#define def_node_generic_debug_ok(fn, name)										\
	NodeGeneric fn##_gf (_T(name), &Value::fn##_vf, DEBUGGER_SAFE)
#define def_mapped_generic_debug_ok(fn, name)									\
	MappedGeneric fn##_gf (_T(name), &Value::fn##_vf, DEBUGGER_SAFE)
...
#define def_primitive_debug_ok(fn, name)								\
	Value* fn##_cf(Value**,int);										\
	Primitive fn##_pf (&_T("%"#name), fn##_cf, DEBUGGER_SAFE)  /* scripter-hidden name */
#define def_visible_primitive_debug_ok(fn, name)						\
	Value* fn##_cf(Value**,int);										\
	Primitive fn##_pf (_T(name), fn##_cf, DEBUGGER_SAFE)
#define def_struct_primitive_debug_ok(fn, _struct, name)				\
	Value* fn##_cf(Value**,int);										\
	Primitive fn##_pf (_T(name), _T(#_struct), fn##_cf, DEBUGGER_SAFE)
#define def_mapped_primitive_debug_ok(fn, name)							\
	Value* fn##_cf(Value**,int);										\
	MappedPrimitive fn##_pf (_T(name), fn##_cf, DEBUGGER_SAFE)
#define def_lazy_primitive_debug_ok(fn, name)							\
	Value* fn##_cf(Value**,int);										\
	Primitive fn##_pf (&_T("%"#name), fn##_cf, LAZY_PRIMITIVE | DEBUGGER_SAFE)
