...
//	def_struct_primitive (					tvw_pickTrackDlg,			trackView,	"pickTrackDlg");
	...
	def_visible_primitive_debug_ok (		get_interfaces,				"getInterfaces");
	def_visible_primitive_debug_ok (		get_interface,				"getInterface");
...
//	def_visible_primitive (					waitForToolStop,			"waitForToolStop");
	...
	def_struct_primitive_debug_ok (			pesistents_remove,				persistents,	"remove");
	def_struct_primitive_debug_ok (			pesistents_removeAll,			persistents,	"removeAll");
	def_struct_primitive_debug_ok (			pesistents_show,				persistents,	"show");
