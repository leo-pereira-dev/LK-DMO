...
class NxProfileZone
	...
	NxU32  hierTime;			//!< Time in clock cycles that it took to execute the total of the calls to this zone.
	NxU32  selfTime;			//!< Time in clock cycles that it took to execute the total of the calls to this zone, minus the time it took to execute the zones called from this zone.  
