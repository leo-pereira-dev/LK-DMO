...
//@{
	...
	*/
	...
	If you supply both of the above, the actor's mass will conform to the totalMass parameter
	but the inertia will conform to the density parameter. Note: This may make the actor act in a 
	non-physical manner.
