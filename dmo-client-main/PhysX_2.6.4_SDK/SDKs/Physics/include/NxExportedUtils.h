...
@see NxBox
*/
NX_INLINE bool NX_CALL_CONV NxBoxContainsPoint(const NxBox& box, const NxVec3& p)
	{
...
@see NxBox NxBounds3
*/
NX_INLINE void NX_CALL_CONV NxCreateBox(NxBox& box, const NxBounds3& aabb, const NxMat34& mat)
	{
...
@see NxBox NxPlane
*/
NX_INLINE bool NX_CALL_CONV NxComputeBoxPlanes(const NxBox& box, NxPlane* planes)
	{
...
@see NxBox
*/
NX_INLINE bool NX_CALL_CONV NxComputeBoxPoints(const NxBox& box, NxVec3* pts)
	{
...
@see NxBox
*/
NX_INLINE bool NX_CALL_CONV NxComputeBoxVertexNormals(const NxBox& box, NxVec3* pts)
	{
...
*/
NX_INLINE const NxU32* NX_CALL_CONV NxGetBoxEdges()
	{
...
@see NxComputeBoxPoints
*/
NX_INLINE const NxI32* NX_CALL_CONV NxGetBoxEdgesAxes()
	{
...
@see NxComputeBoxPoints
*/
NX_INLINE const NxU32* NX_CALL_CONV NxGetBoxTriangles()
	{
...
<b>Platform:</b>
	...
	\li XB360: Yes
*/
NX_INLINE const NxVec3* NX_CALL_CONV NxGetBoxLocalEdgeNormals()
	{
...
<b>Platform:</b>
	...
	\li XB360: Yes
*/
NX_INLINE void NX_CALL_CONV NxComputeBoxWorldEdgeNormal(const NxBox& box, NxU32 edge_index, NxVec3& world_normal)
	{
...
*/
NX_INLINE void NX_CALL_CONV NxComputeCapsuleAroundBox(const NxBox& box, NxCapsule& capsule)
	{
...
@see NxBox
*/
NX_INLINE bool NX_CALL_CONV NxIsBoxAInsideBoxB(const NxBox& a, const NxBox& b)
	{
...
@see NxComputeBoxPoints()
*/
NX_INLINE const NxU32* NX_CALL_CONV NxGetBoxQuads()
	{
...
*/
NX_INLINE const NxU32* NX_CALL_CONV NxBoxVertexToQuad(NxU32 vertexIndex)
	{
...
*/
NX_INLINE void NX_CALL_CONV NxComputeBoxAroundCapsule(const NxCapsule& capsule, NxBox& box)
	{
...
<b>Platform:</b>
	...
	\li XB360: Yes
*/
NX_INLINE void NX_CALL_CONV NxSetFPUPrecision24()
	{
...
<b>Platform:</b>
	...
	\li XB360: Yes
*/
NX_INLINE void NX_CALL_CONV NxSetFPUPrecision53()
	{
...
<b>Platform:</b>
	...
	\li XB360: Yes
*/
NX_INLINE void NX_CALL_CONV NxSetFPUPrecision64()
	{
...
<b>Platform:</b>
	...
	\li XB360: Yes
*/
NX_INLINE void NX_CALL_CONV NxSetFPURoundingChop()
	{
...
<b>Platform:</b>
	...
	\li XB360: Yes
*/
NX_INLINE void NX_CALL_CONV NxSetFPURoundingUp()
	{
...
<b>Platform:</b>
	...
	\li XB360: Yes
*/
NX_INLINE void NX_CALL_CONV NxSetFPURoundingDown()
	{
...
<b>Platform:</b>
	...
	\li XB360: Yes
*/
NX_INLINE void NX_CALL_CONV NxSetFPURoundingNear()
	{
...
<b>Platform:</b>
	...
	\li XB360: Yes
*/
NX_INLINE void NX_CALL_CONV NxSetFPUExceptions(bool b)
	{
...
<b>Platform:</b>
	...
	\li XB360: Yes
*/
NX_INLINE int NX_CALL_CONV NxIntChop(const NxF32& f)
	{
...
<b>Platform:</b>
	...
	\li XB360: Yes
*/
NX_INLINE int NX_CALL_CONV NxIntFloor(const NxF32& f)
	{
...
<b>Platform:</b>
	...
	\li XB360: Yes
*/
NX_INLINE int NX_CALL_CONV NxIntCeil(const NxF32& f)
	{
...
@see NxRay
*/
NX_INLINE NxF32 NX_CALL_CONV NxComputeDistanceSquared(const NxRay& ray, const NxVec3& point, NxF32* t)
	{
...
@see NxSegment
*/
NX_INLINE NxF32 NX_CALL_CONV NxComputeSquareDistance(const NxSegment& seg, const NxVec3& point, NxF32* t)
	{
...
*/
NX_INLINE NxBSphereMethod NX_CALL_CONV NxComputeSphere(NxSphere& sphere, unsigned nb_verts, const NxVec3* verts)
	{
...
*/
NX_INLINE bool NX_CALL_CONV NxFastComputeSphere(NxSphere& sphere, unsigned nb_verts, const NxVec3* verts)
	{
...
@see NxSphere NxComputeSphere
*/
NX_INLINE void NX_CALL_CONV NxMergeSpheres(NxSphere& merged, const NxSphere& sphere0, const NxSphere& sphere1)
	{
...
<b>Platform:</b>
	...
	\li XB360: Yes
*/
NX_INLINE void NX_CALL_CONV NxNormalToTangents(const NxVec3 & n, NxVec3 & t1, NxVec3 & t2)
	{
...
NX_INLINE bool NX_CALL_CONV NxDiagonalizeInertiaTensor(const NxMat33 & denseInertia, NxVec3 & diagonalInertia, NxMat33 & rotation)
	{
...
<b>Platform:</b>
	...
	\li XB360: Yes
*/
NX_INLINE void NX_CALL_CONV NxFindRotationMatrix(const NxVec3 & x, const NxVec3 & b, NxMat33 & M)
	{
...
@see NxBounds3
*/
NX_INLINE void NX_CALL_CONV NxComputeBounds(NxVec3& min, NxVec3& max, NxU32 nbVerts, const NxVec3* verts)
	{
...
<b>Platform:</b>
	...
	\li XB360: Yes
*/
NX_INLINE NxU32 NX_CALL_CONV NxCrc32(const void* buffer, NxU32 nbBytes)
	{
