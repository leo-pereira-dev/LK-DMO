...
#include "PhysXLoader.h"
	...
	\li XB360: Yes
	*/
	NX_INLINE NxReal NX_CALL_CONV NxComputeSphereMass			(NxReal radius, NxReal density)
		{
	...
	\li XB360: Yes
	*/
	NX_INLINE NxReal NX_CALL_CONV NxComputeSphereDensity		(NxReal radius, NxReal mass)
		{
	...
	\li XB360: Yes
	*/
	NX_INLINE NxReal NX_CALL_CONV NxComputeBoxMass			(const NxVec3& extents, NxReal density)
		{
	...
	\li XB360: Yes
	*/
	NX_INLINE NxReal NX_CALL_CONV NxComputeBoxDensity			(const NxVec3& extents, NxReal mass)
		{
	...
	\li XB360: Yes
	*/
	NX_INLINE NxReal NX_CALL_CONV NxComputeEllipsoidMass		(const NxVec3& extents, NxReal density)
		{
	...
	\li XB360: Yes
	*/
	NX_INLINE NxReal NX_CALL_CONV NxComputeEllipsoidDensity	(const NxVec3& extents, NxReal mass)
		{
	...
	\li XB360: Yes
	*/
	NX_INLINE NxReal NX_CALL_CONV NxComputeCylinderMass		(NxReal radius, NxReal length, NxReal density)
		{
	...
	\li XB360: Yes
	*/
	NX_INLINE NxReal NX_CALL_CONV NxComputeCylinderDensity	(NxReal radius, NxReal length, NxReal mass)
		{
	...
	\li XB360: Yes
	*/
	NX_INLINE NxReal NX_CALL_CONV NxComputeConeMass			(NxReal radius, NxReal length, NxReal density)
		{
	...
	\li XB360: Yes
	*/
	NX_INLINE NxReal NX_CALL_CONV NxComputeConeDensity		(NxReal radius, NxReal length, NxReal mass)
		{
	...
	\li XB360: Yes
	*/
	NX_INLINE void NX_CALL_CONV NxComputeBoxInertiaTensor	(NxVec3& diagInertia, NxReal mass, NxReal xlength, NxReal ylength, NxReal zlength)
		{
	...
	\li XB360: Yes
	*/
	NX_INLINE void NX_CALL_CONV NxComputeSphereInertiaTensor(NxVec3& diagInertia, NxReal mass, NxReal radius, bool hollow)
		{
