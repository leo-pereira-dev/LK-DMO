...
#include "PhysXLoader.h"
	...
	\li XB360: Yes
	*/
	NX_INLINE bool NX_CALL_CONV NxBoxBoxIntersect(	const NxVec3& extents0, const NxVec3& center0, const NxMat33& rotation0,
	...
	@see NxBox
	*/
	NX_INLINE bool NX_CALL_CONV NxBoxBoxIntersect(const NxBox& obb0, const NxBox& obb1, bool fullTest=true)
		{
	...
	\li XB360: Yes
	*/
	NX_INLINE bool NX_CALL_CONV NxTriBoxIntersect(const NxVec3 & vertex0, const NxVec3 & vertex1, const NxVec3 & vertex2, const NxVec3 & center, const NxVec3& extents)
		{
	...
	@see NxSepAxis
	*/
	NX_INLINE NxSepAxis NX_CALL_CONV NxSeparatingAxis(	const NxVec3& extents0, const NxVec3& center0, const NxMat33& rotation0,
															const NxVec3& extents1, const NxVec3& center1, const NxMat33& rotation1,
															bool fullTest=true)
		{
	...
	@see NxSepAxis
	*/
	NX_INLINE NxSepAxis NX_CALL_CONV NxSeparatingAxis(const NxBox& obb0, const NxBox& obb1, bool fullTest=true)
	{
