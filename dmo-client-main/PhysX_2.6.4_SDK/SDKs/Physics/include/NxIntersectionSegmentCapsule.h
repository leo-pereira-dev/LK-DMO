...
//namespace NxCollision {
	...
	@see NxRay NxCapsule
	*/
	NX_INLINE NxU32 NX_CALL_CONV NxRayCapsuleIntersect(const NxVec3& origin, const NxVec3& dir, 
	...
	*/
	NX_INLINE void NX_CALL_CONV NxSegmentCapsuleIntersect(const NxSegment& segment, const NxCapsule& capsule, NxU32* nbImpacts, 
		NxReal t[2])
		{
		NxReal s[2];
