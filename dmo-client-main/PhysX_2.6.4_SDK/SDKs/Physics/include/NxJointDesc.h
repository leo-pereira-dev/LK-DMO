...
*/
NX_INLINE void NX_CALL_CONV NxJointDesc_SetGlobalAnchor(NxJointDesc & dis, const NxVec3 & wsAnchor)
	{
	NxGetUtilLib()->NxJointDesc_SetGlobalAnchor(dis,wsAnchor);
	}
...
*/
NX_INLINE void NX_CALL_CONV NxJointDesc_SetGlobalAxis(NxJointDesc & dis, const NxVec3 & wsAxis)
	{
	NxGetUtilLib()->NxJointDesc_SetGlobalAxis(dis,wsAxis);
	}
