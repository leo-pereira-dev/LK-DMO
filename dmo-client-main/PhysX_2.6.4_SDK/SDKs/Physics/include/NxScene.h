...
enum NxThreadPollResult
	...
	*/
	...
	/**
	\brief The function returned because the user called shutdownWorkerThreads()
...
//@{
	...
	*/
	...
	/**
	\brief Creates a spring and damper effector.
...
/************************************************************************************************/
	...
	*/
	...
	\param[out] stats Used to retrieve statistics for the scene. See #NxSceneStats2. 
...
//@{
	...
	*/
	...
	The pre-cooking will only be valid for Fluids which share the specified parameters.
	
	\return Operation succeeded.

	*/
	virtual bool						cookFluidMeshHotspot(const NxBounds3& bounds, NxU32 packetSizeMultiplier, NxReal restParticlesPerMeter, NxReal kernelRadiusMultiplier, NxReal motionLimitMultiplier, NxReal collisionDistanceMultiplier) = 0;

#endif
//@}
/************************************************************************************************/
	
/** @name Implicit Screen Surface
*/
//@{
	...
	/**
	\brief Creates an implicit screen surface for user-defined particles in this scene. 
	...
	*/
	...
	/**
	\brief Deletes the specified implicit screen surface. 
	...
	*/
	...
	/**
	\brief Get the number of implicit screen surfaces belonging to the scene.
	...
	*/
	...
	/**
	\brief Get an array of implicit screen surfaces belonging to the scene.
