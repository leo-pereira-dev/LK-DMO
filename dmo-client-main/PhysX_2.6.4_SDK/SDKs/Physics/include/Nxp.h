...
enum NxShapeFlag
	...
	*/
	...
	NX_SF_CLOTH_DISABLE_COLLISION	= (1<<16),	//!< Disable collision with cloths. Not supported in this release.
	NX_SF_CLOTH_TWOWAY				= (1<<17),	//!< Enables the reaction of the shapes actor on cloth collision. Not supported in this release.
	};
...
enum NxActorFlag
	...
	*/
	...
	This insures that all contacts involving the actor will use cone friction, rather than the default
...
NOTE: Also consider other versions, such as 2.7 when adding new parameters to this list.
*/
...
/* General parameters and new parameters */
	...
	*/
	NX_MIN_SEPARATION_FOR_PENALTY = NX_PARAMS_NUM_VALUES+1
	};
