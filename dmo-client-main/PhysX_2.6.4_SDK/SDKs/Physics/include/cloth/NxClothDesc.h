...
enum NxClothFlag
{
	...
	*/
	...
	Note: At the moment only for internal use.
	...
	*/
	...
	This is because impulses are only transfered between the cloth and rigid body solver outside the solvers.
	...
	*/
	...
	/**
	\brief Defines whether this cloth is simulated on the PPU. To simulate a piece of cloth on the PPU
...
public:
	...
	*/
	...
	For example vertex positions, normals, connectivity (triangles) and parent index information.
