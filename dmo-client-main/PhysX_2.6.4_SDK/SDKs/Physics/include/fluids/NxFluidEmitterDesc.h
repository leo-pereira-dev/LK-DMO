...
class NxFluidEmitterDesc
	...
	relPose is relative to the shapes frame.

	If frameShape is NULL then relPose is relative to the origin.

	The third axis of the orientation frame sets the flow direction.
	*/
    NxMat34					relPose;
