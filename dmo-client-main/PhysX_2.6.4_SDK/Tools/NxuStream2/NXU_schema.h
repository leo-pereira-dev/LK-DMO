...
#endif
/**
\brief Size in distance of a singel cell in the HSM paging grid.
*/
#if NX_SDK_VERSION_NUMBER == 250 || NX_SDK_VERSION_NUMBER == 251
  NX_GRID_HASH_CELL_SIZE,
#endif
/**
\brief Used to designate the correct total number of parameterse
*/
...
{
/**
\brief cook the cloth mesh for software mode
*/
  NX_CLOTH_MESH_SOFTWARE,
/**
\brief NX_CLOTH_MESH_PPU_ATHENA  cook the cloth mesh for hardware (PPU Athena) mode
*/
  NX_CLOTH_MESH_PPU_ATHENA,
};
...
/**
\brief Soft body mesh targets for cooking
*/
enum NxSoftBodyMeshTarget
{
/**
\brief cook the cloth mesh for software mode
*/
  NX_SOFTBODY_MESH_SOFTWARE,
/**
\brief cook the cloth mesh for hardware mode
*/
  NX_SOFTBODY_MESH_PPU_ATHENA,
};
...
*/
  NxArray< NxU32 >                               mVertexFlags;
/**
\brief Defines how the soft body mesh is cooked
*/
  NxSoftBodyMeshTarget                           target;
  void *mInstance;
};
