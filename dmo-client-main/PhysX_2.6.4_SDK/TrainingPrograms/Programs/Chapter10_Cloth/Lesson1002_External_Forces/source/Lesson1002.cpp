...
void SetupFlagScene()
{
	...
	NxActor* capsule = CreateCapsule(NxVec3(0.0,-0.2,0.0), 12, 0.2, 0); 

	NxClothDesc clothDesc;
	clothDesc.globalPose.t = NxVec3(0,12,0);
...
//	clothDesc.flags &= ~NX_CLF_GRAVITY;
	...
	MyCloth* regularCloth = new MyCloth(gScene, clothDesc, 8, 8, 0.15, "ageia.bmp");
...
{
	PrintControls();
	InitGlut(argc, argv, "Lesson 1002: External Forces");
	SetDataDirectory();
    InitNx();
    glutMainLoop();
	ReleaseNx();
