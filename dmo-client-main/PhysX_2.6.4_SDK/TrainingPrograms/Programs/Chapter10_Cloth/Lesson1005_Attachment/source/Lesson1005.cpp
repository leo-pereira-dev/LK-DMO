...
void SetupAttachmentScene()
{
	...
	NxActor* attachedBox = CreateBox(NxVec3(-7.25,3.5,2.0), NxVec3(1.25,1,1), 0.5);
	NxActor* attachedSphere = CreateSphere(NxVec3(0.0,3.5,2.0), 1.3, 0.5);
	NxActor* attachedCapsule = CreateCapsule(NxVec3(9.0,4.5,2.0),2.0, 1, 1); 
	...
	clothDesc.globalPose.t = NxVec3(1,5,1);
	...
	clothDesc.globalPose.t = NxVec3(-6.2,5,1);
	...
	clothDesc.globalPose.t = NxVec3(8.1,5,1);
...
{
	PrintControls();
	InitGlut(argc, argv, "Lesson 1005: Attachment");
	SetDataDirectory();
    InitNx();
    glutMainLoop();
	ReleaseNx();
