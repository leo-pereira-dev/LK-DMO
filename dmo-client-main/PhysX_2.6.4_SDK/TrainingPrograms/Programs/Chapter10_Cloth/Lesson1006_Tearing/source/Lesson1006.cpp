...
void SetupTearingScene()
{
	...
	NxActor* bar = CreateBox(NxVec3(0,10,0), NxVec3(3,0.5,0.5), 0);
	NxActor* box = CreateBox(NxVec3(2.3,6,0), NxVec3(0.5,0.5,0.5), 10); 

	NxClothDesc clothDesc;
	clothDesc.globalPose.t = NxVec3(2.5,10,0);
	...
	//clothDesc.pressure = 0;
	clothDesc.tearFactor = 4;
	...
	regularCloth->getNxCloth()->attachToShape(*bar->getShapes(), NX_CLOTH_ATTACHMENT_TWOWAY);
