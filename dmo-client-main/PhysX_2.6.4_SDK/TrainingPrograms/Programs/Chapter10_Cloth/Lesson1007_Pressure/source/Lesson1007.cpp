...
void SetupPressureScene()
{
	...
	clothDesc.pressure = 2;
	//clothDesc.tearFactor = 2.2;
	...
	gCameraPos.set(-4.98,17.8,25.6);
	gCameraForward.set(0.17,-0.47,-0.87);
	gCameraForward.normalize();
}
...
{
	PrintControls();
	InitGlut(argc, argv, "Lesson 1007: Pressure");
	SetDataDirectory();
    InitNx();
    glutMainLoop();
	ReleaseNx();
