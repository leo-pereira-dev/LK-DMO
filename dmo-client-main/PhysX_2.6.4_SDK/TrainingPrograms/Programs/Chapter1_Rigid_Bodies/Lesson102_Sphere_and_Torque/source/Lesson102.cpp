...
void InitGlut(int argc, char** argv)
{
    ...
    gMainHandle = glutCreateWindow("Lesson 102: Sphere and Torque");
...
NxActor* CreateSphere(const NxVec3& pos)
{
	...
	// The actor has one shape, a sphere, radius is 1m
...
void InitNx()
{
 ...
 if(!gScene){ 
	...
	sphere = CreateSphere(NxVec3(0,1,0));
	box = CreateBox(NxVec3(5,1,0));
