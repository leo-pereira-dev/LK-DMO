...
void InitGlut(int argc, char** argv)
{
    ...
    gMainHandle = glutCreateWindow("Lesson 103: Capsule, Local Pose, and Center of Mass");
...
void InitNx()
{
 ...
 if(!gScene){ 
	...
	capsule = CreateCapsule(NxVec3(0,0,0), 2, 0.5, 10);
	sphere = CreateSphere(NxVec3(-5,0,5), 1, 10);
