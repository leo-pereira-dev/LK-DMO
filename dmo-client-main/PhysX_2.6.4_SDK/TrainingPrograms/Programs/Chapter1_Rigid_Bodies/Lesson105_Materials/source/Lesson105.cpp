...
void InitNx()
{
 ...
 if(!gScene){ 
	...
	box = CreateBox(NxVec3(0,10,0), NxVec3(1.5,1.5,1.5), 50);
	boxes = CreateStack(NxVec3(8,0,0), NxVec3(2,2,2), NxVec3(1,1,1), 10);

	gSelectedActor = box;
	gForceStrength = 2000000;
	bPause = true;
...
{
	PrintControls();
	InitGlut(argc, argv, "Lesson 105: Materials");
    InitNx();
    glutMainLoop();
	ReleaseNx();
	return 0;
