...
void InitNx()
{
 ...
 if(!gScene){ 
	...
	concaveObject = CreateConcaveObject(NxVec3(-4,0,0), NxVec3(1,1,1), 5);
	box = CreateBox(NxVec3(4,0,0), NxVec3(0.5,0.5,0.5), 80);
...
{
	PrintControls();
	InitGlut(argc, argv, "Lesson 114: Concave Objects");
    InitNx();
    glutMainLoop();
	ReleaseNx();
	return 0;
