...
void InitNx()
{
 ...
 if(!gScene){ 
	...
	sphere1 = CreateSphere(NxVec3(-3,4,0), 1, 5);
	sphere1->raiseBodyFlag(NX_BF_FROZEN_ROT);
	sphere2 = CreateSphere(NxVec3(3,4,0), 1, 5);
	...
	distanceJoint = CreateDistanceJoint(sphere1, sphere2, anchor1, anchor2, globalAxis2);
...
{
	PrintControls();
	InitGlut(argc, argv, "Lesson 213: Distance Joints");
    InitNx();
    glutMainLoop();
	ReleaseNx();
	return 0;
