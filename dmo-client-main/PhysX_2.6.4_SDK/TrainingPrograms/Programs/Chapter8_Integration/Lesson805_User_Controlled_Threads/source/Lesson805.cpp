...
/**
	SampleThreading, a sample demonstrating the use of the threading interface available in
	the PhysX SDK 2.4+
	...
	NOTE: This sample expects to be able to find a core dump named level.cda. This provides the scene for testing.
 */
...
void InitGlut(int argc, char** argv)
{
    ...
    gMainHandle = glutCreateWindow("Lesson 805: User Controlled Threads");
...
void InitNx()
{
	...
	gPhysicsSDK = NxCreatePhysicsSDK(NX_PHYSICS_SDK_VERSION, gAllocator, new ErrorStream());
