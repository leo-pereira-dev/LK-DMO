...
void CoreDump::WriteParam(NxParameter p,NxReal v)
{
	if ( mFph )
	{
		...
		//#endif
				...
				case NX_IMPLICIT_SWEEP_CACHE_SIZE:
					param = "NX_IMPLICIT_SWEEP_CACHE_SIZE"; break;
#endif

#if NX_SDK_VERSION_NUMBER >= 260
				case NX_DEFAULT_SLEEP_ENERGY:
					param = "NX_DEFAULT_SLEEP_ENERGY";
					break;
				case NX_VISUALIZE_FLUID_STC_COLLISION:
					param	=	"NX_VISUALIZE_FLUID_COLLISION";
					break;
				case NX_VISUALIZE_FLUID_MESH_PACKETS:
					param	=	"NX_VISUALIZE_FLUID_MESH_PACKETS";
					break;
#endif

#if NX_SDK_VERSION_NUMBER >= 260
				case NX_VISUALIZE_CLOTH_MESH:
					param = "NX_VISUALIZE_CLOTH_MESH";
					break;
#endif
				case NX_VISUALIZE_CLOTH_SLEEP:
					param =	"NX_VISUALIZE_CLOTH_SLEEP";	break;
				default:
				  assert(0);
				  break;
			}
...
/* OLD_FLUID_API
			...
			PrintFlag( actorDesc.flags,	"NX_AF_FLUID_ACTOR_REACTION", NX_AF_FLUID_ACTOR_REACTION	);
#endif
*/
...
#if NX_SDK_VERSION_NUMBER >= 230
			WriteInt_b(	 reinterpret_cast<size_t>(	d.ccdSkeleton )	);
#endif
...
//			PrintFlag( desc.flags, "NX_MF_SPRING_CONTACT", NX_MF_SPRING_CONTACT );
		}
