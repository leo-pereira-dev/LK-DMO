...
#include "PrefsRenderer.h"
#include "GLFontRenderer.h"
#include "Timing.h"

PrefsRenderer::PrefsRenderer()
{
	m_profilerOn = false;
...
void PrefsRenderer::toggleEnable()
{
	m_profilerOn = !m_profilerOn;
}

void PrefsRenderer::render(const NxProfileData* prof, int width, int height)
{
	if(!m_profilerOn)
		return;
...
float PrefsRenderer::computeFPS()
{
