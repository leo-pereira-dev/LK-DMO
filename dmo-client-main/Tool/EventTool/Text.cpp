...
void cText::sTEXTINFO::Init( CFreeFont* pFont, int nFontSize /*=CFreeFont::FS_10*/, NiColor color /*=NiColor::WHITE*/ )
{
	s_pFont = pFont;
...
bool cText3D::Init3D( cText::sTEXTINFO* pTextInfo )
{
	...
	m_pBillBoardText->Create( m_ptStrSize.x*0.5f, m_ptStrSize.y*0.5f, m_pTexture );	
