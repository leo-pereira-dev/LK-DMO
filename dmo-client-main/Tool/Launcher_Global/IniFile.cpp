...
// 	_stprintf_s(strInitFileName, 1000, L"%s\\%s", strFilePath, lpFileName);
	...
	nRet = GetPrivateProfileString(lpAppName, lpKeyName, INI_READ_DEFAULT_STRING, pBuf, sizeof(pBuf), lpFileName);
...
// 	_stprintf_s(strInitFileName, 1000, L"%s\\%s", strFilePath, lpFileName);
	...
	nRet = GetPrivateProfileInt(lpAppName, lpKeyName, defaultvalue, lpFileName);
...
// 	_stprintf_s(strInitFileName, 1000, L"%s\\%s", strFilePath, lpFileName);
	...
	BOOL bRet = WritePrivateProfileString(lpAppName, lpKeyName, lpString, lpFileName);
...
// 	_stprintf_s(strInitFileName, 1000, L"%s\\%s", strFilePath, lpFileName);
	...
	BOOL bRet = WritePrivateProfileString(lpAppName, lpKeyName, buffer, lpFileName);
