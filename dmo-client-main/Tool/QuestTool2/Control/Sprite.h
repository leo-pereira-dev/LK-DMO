...
public:
	...
	void				Init( cWindow* pParent, CsPoint pos, CsPoint size, char* cImagePath, float fScaleUI, bool bApplyWindowSize, NiColor color = NiColor::WHITE, bool bUseWorkingFolder = true );
	void				Init( cWindow* pParent, CsPoint pos, CsPoint size, NiTexture* pTexture, float fScaleUI, bool bApplyWindowSize, NiColor color = NiColor::WHITE );
	void				Init( cWindow* pParent, CsPoint pos, CsPoint size, float fScaleUI, bool bApplyWindowSize, NiColor color = NiColor::WHITE );
