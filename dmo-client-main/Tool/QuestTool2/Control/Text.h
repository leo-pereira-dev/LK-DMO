...
public:
	struct sTEXTINFO
	{
		...
		// 초기화
		void	Init( int nFontSize = cFont::FS_10, NiColor color = NiColor::WHITE );
	...
	public:
		void			SetText( TCHAR const* szText ){ _tcscpy_s( s_szText, MAX_PATH, szText ); }
...
public:
	...
	void		Init( cWindow* pParent, CsPoint pos, sTEXTINFO* pText, float fScaleUI, bool bApplyWindowSize );
