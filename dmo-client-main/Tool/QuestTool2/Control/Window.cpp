...
void cWindow::Init( cWindow* pParent, CsPoint pos, CsPoint size, float fScaleUI, bool bApplyWindowSize )
{
	m_pParentWindow = pParent;
	m_bApplyWindowSize = bApplyWindowSize;
	m_fScaleUI = fScaleUI;

	m_ptSize = size*fScaleUI;
	m_ptDefault = pos;
	...
	{
		m_ptClient = xy*m_fScaleUI + m_pParentWindow->GetClient();
	}
	else
	{
		m_ptClient = xy;
