...
class _DlgViewList : public CDialog
{
	DECLARE_DYNAMIC(_DlgViewList)
...
public:
	_DlgViewList(CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~_DlgViewList();

// 대화 상자 데이터입니다.
	enum { IDD = IDD_DIALOG_VIEW_LIST };
