...
public:
	bool Init(void);
	bool Connect(char const *szSvrName, UINT nSvrPort, char const *szUserID, char const *szUserPass, bool bIsPassive=false);
	void Close(void);

public:
	bool GetFile(char const*szRemoteFile, char const*szLocalFile);
