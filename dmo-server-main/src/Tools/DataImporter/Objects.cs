...
namespace DataImporterTool
{
    public partial class Form1
    {
        ...
        public class MonsterSkillObject
        {
            ...
            //TODO: falta sÃ³ area e dano (maioria do dano Ã© 0 mesmo). Para a area, fazer join no SkillTerms
        ...
        public enum eNPC_TYPE : int        // ë°ëë©´ ìëë¤.
        {
            NT_NONE = 0,
            NT_TRADE = 1,
            NT_DIGITAMA_TRADE = 2,
            ...
            NT_INFINITEWAR_MANAGER_NPC = 22,        // ë¬´íëì  ì§í NPC
            NT_INFINITEWAR_NOTICEBOARD_NPC = 23,    // ë¬´íëì  ê²ìí NPC
        ...
        {
            EVENT_NONE = 0,
            EVENT_CARDGAME = 1, // í¼ìëª¬ ì¹´ë ê²ì
            EVENT_PINOKIMON = 2,    // 2014 ê²¨ì¸(í¬ë¦¬ì¤ë§ì¤)ì´ë²¤í¸
        }
        ...
        public class StageInfos
        {
            ...
            public int s_dwRewardItemIdx;      // CÃ³digo do item pago pelo ponto de fluxo para a vitÃ³ria / derrota
            public int s_nWinPoint;            // Ponto de pagamento para a vitÃ³ria
            public int s_nLosePoint;           // Ponto de pagamento para derrota
            public int s_nMonsterInfoIndex;    // InformaÃ§Ãµes sobre o monstro para co
